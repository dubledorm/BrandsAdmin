...
RSpec.describe PostamatReleaseStatus, type: :model do
  ...
  PRS_ATTRIBUTES_JSON = '{"number":"123-456","status":"New",' \
'"dateCreate":null,"dateUpdate":null,"errors":' \
'["{\"message\":\"123-1\",\"details\":\"456-1\",\"dateCreate\":\"2022-11-17T09:18:48.852Z\"}",' \
'"{\"message\":\"123-2\",\"details\":\"456-2\",\"dateCreate\":\"2022-11-17T09:18:48.852Z\"}"]}'
